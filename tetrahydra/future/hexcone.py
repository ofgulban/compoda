...
coords = np.linspace(200, 201, parcels)
...
ax_1.scatter(data[:, 0], data[:, 1], data[:, 2], color='r', s=5)

ax_2 = plt.subplot(132)
ax_2.scatter(ilr[:, 0], ilr[:, 1], color='g', s=5.)
...
ax_3.scatter(hexc[:, 0], hexc[:, 1], hexc[:, 2], color='b', s=5)
